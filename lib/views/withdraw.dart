...
class _WithdrawState extends State<Withdraw> {
  ...
  var firstName = 'user',
      ...
      id = 'id',
      amount = 500,
      eventtitle = '', //TODO: Add event title
  ...
  Widget build(BuildContext context) {
    Map arguements = ModalRoute.of(context).settings.arguments;
    DocumentSnapshot eventData = arguements['eventData'];
    FirebaseUser currentUser = arguements['user'];
    return Scaffold(
      key: _scaffoldKey,
      appBar: AppBar(
        title: Text(
      ...
      body: Column(
        children: <Widget>[
          ...
          GestureDetector(
            onTap: () {
              _processMtnMM(eventData, currentUser);
            },
            child: Container(
              child: Text(
                'PAY',
  ...
  void _processMtnMM(eventData, currentUser) {
    _phoneErrorText = '';
    ...
    // _showMobileMoneyProcessingDialog();
      ...
      )); //TODO: Add snackbar to say please wait, transaction is being processed
    _initiateMobileMoneyPaymentFlow(phone, amount, eventData, currentUser);
  }

  void _initiateMobileMoneyPaymentFlow(
      String phone, String amount, eventData, currentUser) async {
    _userDismissedDialog = false;
    ...
    Map<String, dynamic> payload = {
      ...
      'meta': [
        {
          'metaname': 'userId',
          'metavalue': currentUser.uid,
        },
        {
          'metaname': 'eventId',
          'metavalue': eventData.documentID,
        }
      ],
